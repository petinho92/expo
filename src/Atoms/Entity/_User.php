...
#[Validator("group", \Symfony\Component\Validator\Constraints\Choice::class, ['multiple'=>false,'choices'=>['admin','staff','visitor']])]
#[Field("group", \Atomino\Carbon\Field\EnumField::class, ['admin','staff','visitor'])]
