...
#[Validator("group", \Symfony\Component\Validator\Constraints\Choice::class, ['multiple'=>false,'choices'=>['admin','visitor']])]
#[Field("group", \Atomino\Carbon\Field\EnumField::class, ['admin','visitor'])]
